...
// ---------------------------------------------------------------------------
// Partners / "Rakan Strategik" — Johor navy + red theme
// ---------------------------------------------------------------------------
export function PartnersSection() {
  return (
    ...
    >
      {/* Decorative blobs — red accent */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-32 -bottom-32 h-80 w-80 rounded-full bg-johor-red-500/15 blur-3xl" />
        <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-johor-red-500/10 blur-3xl" />
      </div>

      <div className="container relative mx-auto px-4">
        {/* Section heading */}
        <div className="mb-10 text-center">
          <p className="mb-2 text-sm font-semibold uppercase tracking-wider text-johor-red-400">
            Rakan Strategik
          </p>
          <h2
            id="partners-heading"
          ...
          >
            {SCROLLING_LIST.map((partner, idx) => (
              <li
                ...
                className="flex h-20 w-36 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/10 backdrop-blur-sm p-3 transition-all hover:border-johor-red-500/50 hover:bg-white/15 hover:shadow-lg sm:h-24 sm:w-44"
                title={partner.name}
              >
                <Image
                  src={partner.logo}
